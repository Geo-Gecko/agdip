...
var fieldName = ['NDVI_JFM', 'NDVWI_JFM', 'Soil_Phosp', 'Soil_Alumi', 'Soil_Potas', 'Soil_Boron', 'Rainfall', 'ppp_sum', 'Land_Cover', 'Slope', 'Elevation'];
...
function addValues() {
  ...
  for (key in layer['_layers']) {
    ...
    // if (l['feature']['properties']['NDVI_JFM'] > parseFloat(realRange[0][0]) && l['feature']['properties']['NDVI_JFM'] < parseFloat(realRange[0][1])) {
